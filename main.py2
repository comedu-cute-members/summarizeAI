...
summary_AI_background=tk.PhotoImage(file="background.png", master=summary_AI)
summary_AI_background_label=tk.Label(summary_AI, image=summary_AI_background)
summary_AI_background_label.place(x=-200, y=-20)
...
#Text 상자 위치 조정
original_text_box_message = tk.Label(summary_AI, text="요약할 원문을 붙여넣기 하거나 파일을 불러오세요.", font=('Arial', 15, 'bold'),)
...
summary_text_box_message = tk.Label(summary_AI, text="요약된 텍스트가 여기 표시됩니다.",font=('Arial', 15, 'bold'))
